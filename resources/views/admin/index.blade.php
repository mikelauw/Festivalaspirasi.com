<!doctype html>
<html lang="en">
<!-- Mirrored from kero.architectui.com/demo/kero-html-sidebar-pro/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Apr 2021 18:40:54 GMT -->
...
<link href="{{env('APP_URL')}}css/admin/style.css" rel="stylesheet"></head>
<body>
                    ...
                    <div class="scrollbar-sidebar scrollbar-container">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                <li>
                                    <a href="#">
                                        <i class="metismenu-icon pe-7s-monitor"></i>Dashboard
                                    </a>
                                </li>
...
<script type="text/javascript" src="{{env('APP_URL')}}js/kero.js"></script></body>
</html>
