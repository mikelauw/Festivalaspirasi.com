	    ...
	    <div class="container-fluid">
	        <div class="row">
	            ...
	            <div class="col-7">
	                <div id="social">
	                    <ul>
	                        <li><a href="#0" target="_blank"><i class="social_facebook"></i></a></li>
	                        <li><a href="#0" target="_blank"><i class="social_twitter"></i></a></li>
	                        <li><a href="#0" target="_blank"><i class="social_instagram"></i></a></li>
	                        <li><a href="#0" target="_blank"><i class="social_youtube"></i></a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
	            ...
	            <div class="row justify-content-between">
	                <div class="col-xl-6 col-lg-6 d-flex align-items-center">
	                    <div class="main_title_1">
	                        <h3><img src="img/main_icon_1.svg" width="80" height="80" alt=""> Festival Aspirasi</h3>
